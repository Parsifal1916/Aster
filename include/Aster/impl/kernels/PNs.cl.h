...
inline std::string cl_pns_lite = 
"#define WG 256\n"
"float get_A1(float eta, float2 v, float r_dot, float m, float r){\n"
"    return -(1 + 3*eta) * dot(v, v) + 3/2 * eta * r_dot * r_dot + 2*(2 + eta) * m / r; \n"
"}\n"
"\n"
...
"}\n"
"\n"
"float get_A2(float eta, float2 v, float r_dot, float m, float r){\n"
...
"}\n"
"\n"
"float get_B2(float eta, float2 v, float r_dot, float m, float r){\n"
...
"}\n"
"\n"
"float get_B25(float eta, float2 v, float r_dot, float m, float r){\n"
"    return dot(v, v) + 3 * m /r;\n"
"}\n"
"\n"
"__kernel void pn25(\n"
...
"    float2 this_vel = velocities[i];\n"
"\n"
"    __local float2 spos[WG];\n"
"    __local float  sm  [WG];\n"
"    __local float2  svel[WG];\n"
"\n"
"    for (uint tile = 0; tile < N; tile += WG) {\n"
"        uint lid = get_local_id(0);\n"
"        uint j   = tile + lid;\n"
